...
void drawSmallString_impl(Gfx **dl, int x, int y, const char* string, unsigned int r, unsigned int g, unsigned int b) {
  int i = 0;
  int xPos = x;
  int yPos = y;
  u8 s = 0;
...
void drawSmallStringCol(Gfx **dl, int x, int y, const char* string, unsigned int r, unsigned int g, unsigned int b) {
